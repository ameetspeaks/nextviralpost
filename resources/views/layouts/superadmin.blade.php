...
<body class="bg-gray-100">
    <div class="min-h-screen flex">
        ...
        <div class="w-64 bg-[#1a1942] text-white">
            ...
            <nav class="mt-4">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 {{ request()->routeIs('admin.dashboard') ? 'bg-gray-800' : '' }}">
                ...
                <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center">
                            <span class="mr-4 text-sm text-gray-600">Welcome, {{ Auth::user()->full_name }}</span>
