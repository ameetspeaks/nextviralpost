    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-64 bg-[#1a1942] text-white">
            ...
            <nav class="mt-4">
                ...
                <a href="{{ route('admin.subscription-plans.index') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 {{ request()->routeIs('admin.subscription-plans.*') ? 'bg-gray-800' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.posts.index') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 {{ request()->routeIs('admin.posts.*') ? 'bg-gray-800' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path>
                    </svg>
                    All Posts
                </a>
                <a href="{{ route('admin.trending-prompts.index') }}" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 {{ request()->routeIs('admin.trending-prompts.*') ? 'bg-gray-800' : '' }}">
