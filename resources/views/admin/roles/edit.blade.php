                ...
                <div>
                    ...
                    <div class="mt-2 space-y-2">
                        <div class="flex items-center">
                            <input type="checkbox" name="permissions[edit_content]" value="1" 
                                {{ old('permissions.edit_content', $role->permissions['edit_content'] ?? false) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                            <label class="ml-2 text-sm text-gray-700">Edit Content</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="permissions[manage_users]" value="1" 
                                {{ old('permissions.manage_users', $role->permissions['manage_users'] ?? false) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                            <label class="ml-2 text-sm text-gray-700">Manage Users</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="permissions[manage_roles]" value="1" 
                                {{ old('permissions.manage_roles', $role->permissions['manage_roles'] ?? false) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
