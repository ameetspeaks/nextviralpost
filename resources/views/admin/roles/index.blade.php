        ...
        <div class="flex-1 overflow-auto">
            <div class="p-8">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('admin.roles.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">
                        Add New Role
                    </a>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($roles as $role)
                                <tr>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">{{ Str::limit($role->description, 100) }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
