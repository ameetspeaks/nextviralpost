        ...
        <div class="flex-1 overflow-auto">
            <div class="p-8">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-semibold text-gray-800">Edit Interest</h1>
                    <a href="{{ route('admin.interests.index') }}" class="text-blue-500 hover:text-blue-700">
                        Back to Interests
                    </a>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <form action="{{ route('admin.interests.update', $interest) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $interest->name) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="3" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $interest->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $interest->is_active) ? 'checked' : '' }}
